...
: Filter("RingOutlierFilter", options)
{
  ...
  updater_.add("RingOutlierFilterStatus", this, &RingOutlierFilterComponent::checkDiagnostics);
...
void RingOutlierFilterComponent::checkDiagnostics(diagnostic_updater::DiagnosticStatusWrapper & stat)
{
