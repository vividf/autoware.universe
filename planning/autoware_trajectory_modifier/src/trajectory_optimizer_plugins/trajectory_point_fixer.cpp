...
#include "autoware/trajectory_modifier/trajectory_optimizer_plugins/trajectory_point_fixer.hpp"
...
void TrajectoryPointFixer::on_initialize(const TrajectoryModifierParams & params)
{
  enabled_ = params.use_trajectory_point_fixer;
  fixer_params_ = params.trajectory_point_fixer;
}

void TrajectoryPointFixer::update_params(const TrajectoryModifierParams & params)
{
  enabled_ = params.use_trajectory_point_fixer;
  fixer_params_ = params.trajectory_point_fixer;
}
