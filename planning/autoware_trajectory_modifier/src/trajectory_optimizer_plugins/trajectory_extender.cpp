...
#include "autoware/trajectory_modifier/trajectory_optimizer_plugins/trajectory_extender.hpp"

#include "autoware/trajectory_modifier/trajectory_optimizer_plugins/plugin_utils/trajectory_extender_utils.hpp"
...
void TrajectoryExtender::on_initialize(const TrajectoryModifierParams & params)
{
  enabled_ = params.use_trajectory_extender;
  extender_params_ = params.trajectory_extender;
}

void TrajectoryExtender::update_params(const TrajectoryModifierParams & params)
{
  enabled_ = params.use_trajectory_extender;
  extender_params_ = params.trajectory_extender;
}
