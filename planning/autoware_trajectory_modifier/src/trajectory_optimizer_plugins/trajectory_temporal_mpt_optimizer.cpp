...
#include "autoware/trajectory_modifier/trajectory_optimizer_plugins/plugin_utils/trajectory_temporal_mpt_optimizer_utils.hpp"
...
void TrajectoryTemporalMPTOptimizer::log_debug_info(
  ...
  const TrajectoryModifierData & data, const TrajectoryPoints & traj_points)
{
...
void TrajectoryTemporalMPTOptimizer::log_acados_solve_debug(
  ...
  const size_t terminal_idx, const TrajectoryModifierData & data,
