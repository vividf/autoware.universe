...
#include "autoware/trajectory_modifier/trajectory_optimizer_plugins/trajectory_spline_smoother.hpp"

#include "autoware/trajectory_modifier/trajectory_optimizer_plugins/plugin_utils/trajectory_spline_smoother_utils.hpp"
...
void TrajectorySplineSmoother::on_initialize(const TrajectoryModifierParams & params)
{
  enabled_ = params.use_akima_spline_interpolation;
  spline_params_ = params.trajectory_spline_smoother;
}

void TrajectorySplineSmoother::update_params(const TrajectoryModifierParams & params)
{
  enabled_ = params.use_akima_spline_interpolation;
  spline_params_ = params.trajectory_spline_smoother;
}
