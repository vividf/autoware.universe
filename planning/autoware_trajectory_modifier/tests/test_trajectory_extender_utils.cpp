...
using autoware::trajectory_modifier::plugin::trajectory_extender_utils::add_ego_state_to_trajectory;
using autoware::trajectory_modifier::plugin::trajectory_extender_utils::
