...
using autoware::trajectory_modifier::plugin::trajectory_mpt_optimizer_utils::
...
using autoware::trajectory_modifier::plugin::trajectory_mpt_optimizer_utils::generate_bounds;
using autoware::trajectory_modifier::plugin::trajectory_mpt_optimizer_utils::
