...
protected:
  ...
  void SetUp() override
  {
    ...
    processor_options.arguments(
      {"--ros-args",
       "--params-file",
       processor_dir + "/config/trajectory_modifier.param.yaml",
       "--params-file",
    ...
    processor_node_ =
      std::make_shared<autoware::trajectory_modifier::TrajectoryModifier>(processor_options);
  ...
  std::shared_ptr<autoware::trajectory_modifier::TrajectoryModifier> processor_node_;
