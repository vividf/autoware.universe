...
using autoware::trajectory_modifier::plugin::trajectory_velocity_optimizer_utils::clamp_velocities;
using autoware::trajectory_modifier::plugin::trajectory_velocity_optimizer_utils::set_max_velocity;
