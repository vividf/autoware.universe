...
#ifndef PLANNING__AUTOWARE_TRAJECTORY_MODIFIER__TESTS__TEST_UTILS_HPP_
#define PLANNING__AUTOWARE_TRAJECTORY_MODIFIER__TESTS__TEST_UTILS_HPP_
...
#endif  // PLANNING__AUTOWARE_TRAJECTORY_MODIFIER__TESTS__TEST_UTILS_HPP_
