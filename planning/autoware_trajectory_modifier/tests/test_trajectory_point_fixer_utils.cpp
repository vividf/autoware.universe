...
#include "autoware/trajectory_modifier/trajectory_optimizer_plugins/plugin_utils/trajectory_point_fixer_utils.hpp"
...
using autoware::trajectory_modifier::plugin::trajectory_point_fixer_utils::
...
using autoware::trajectory_modifier::plugin::trajectory_point_fixer_utils::normalize_values;
using autoware::trajectory_modifier::plugin::trajectory_point_fixer_utils::
  remove_close_proximity_points;
using autoware::trajectory_modifier::plugin::trajectory_point_fixer_utils::remove_invalid_points;
using autoware::trajectory_modifier::plugin::trajectory_point_fixer_utils::
  resample_close_proximity_points;
using autoware::trajectory_modifier::plugin::trajectory_point_fixer_utils::resample_single_cluster;
...
TEST_F(PointFixerUtilsTest, ResampleCloseProximityPoints_NoClosePoints)
{
  ...
  autoware::trajectory_modifier::SemanticSpeedTracker tracker;  // Empty tracker for this test
