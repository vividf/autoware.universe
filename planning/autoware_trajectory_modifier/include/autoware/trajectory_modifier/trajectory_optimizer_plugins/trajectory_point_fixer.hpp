...
#ifndef AUTOWARE__TRAJECTORY_MODIFIER__TRAJECTORY_OPTIMIZER_PLUGINS__TRAJECTORY_POINT_FIXER_HPP_
#define AUTOWARE__TRAJECTORY_MODIFIER__TRAJECTORY_OPTIMIZER_PLUGINS__TRAJECTORY_POINT_FIXER_HPP_
...
class TrajectoryPointFixer : public TrajectoryModifierPluginBase
{
public:
...
private:
  trajectory_modifier_params::Params::TrajectoryPointFixer fixer_params_;
};
}  // namespace autoware::trajectory_modifier::plugin

#endif  // AUTOWARE__TRAJECTORY_MODIFIER__TRAJECTORY_OPTIMIZER_PLUGINS__TRAJECTORY_POINT_FIXER_HPP_
