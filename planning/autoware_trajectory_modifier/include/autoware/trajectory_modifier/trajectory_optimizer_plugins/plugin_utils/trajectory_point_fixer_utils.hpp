...
// NOLINTNEXTLINE
#ifndef AUTOWARE__TRAJECTORY_MODIFIER__TRAJECTORY_OPTIMIZER_PLUGINS__PLUGIN_UTILS__TRAJECTORY_POINT_FIXER_UTILS_HPP_
// NOLINTNEXTLINE
#define AUTOWARE__TRAJECTORY_MODIFIER__TRAJECTORY_OPTIMIZER_PLUGINS__PLUGIN_UTILS__TRAJECTORY_POINT_FIXER_UTILS_HPP_
...
namespace autoware::trajectory_modifier::plugin::trajectory_point_fixer_utils
{
using autoware::trajectory_modifier::SemanticSpeedTracker;
...
// NOLINTNEXTLINE
#endif  // AUTOWARE__TRAJECTORY_MODIFIER__TRAJECTORY_OPTIMIZER_PLUGINS__PLUGIN_UTILS__TRAJECTORY_POINT_FIXER_UTILS_HPP_
